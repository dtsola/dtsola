...
### 💰 小遥账单
+ **GitHub**：[https://github.com/dtsola/xiaoyaoprivatebill](https://github.com/dtsola/xiaoyaoprivatebill)
+ **定位**：支付宝微信账单一键智能分析

看清每一分钱的去向，每月省下不该花的钱。

### 🤖 小遥配配
+ **GitHub**：[https://github.com/dtsola/xiaoyaopeipei](https://github.com/dtsola/xiaoyaopeipei)
+ **定位**：AI 对话式电脑导购

24小时在线，帮你智能接单、推荐合适配置。

### 📄 小遥搜索飞书导出工具
+ **GitHub**：[https://github.com/dtsola/xiaoyaosearch-feishu-export-md](https://github.com/dtsola/xiaoyaosearch-feishu-export-md)
+ **定位**：飞书文档一键导出 Markdown

方便快捷地将飞书文档转换为Markdown格式。
